...
export default {
    ...
    methods: {
        ...
        crearPeriodo(){
            this.showCrearPeriodo = !this.showCrearPeriodo;
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown" @click="showOptions" >
                            <div href="#" class="nav-link">
                                <i class="bi bi-calendar"></i> Periodo Academico
                            </div>
            ...
            <div class="card-body">
                <form class="form-inline" v-on:submit.prevent="agregarProductos">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <div class="m-auto">
                                <button @click="agregarProductos" type="submit" class="btn btn-primary ml-sm-2 mr-sm-4 my-5">Agregar Periodo</button>
                            </div>
                        </li>
                    </ul>
                </form>
